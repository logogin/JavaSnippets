 ...
 */
/**
 * An example for comment formatting. This example is meant to illustrate the various possibilities offered by <i>Eclipse</i> in order to format comments. bump
 * bump bump bump .
 */
...
interface Example {
    ...
    /*
     * block comment on first column bump bump bump bump bump bump bump bump bump bump bump bump bump bump bump bump bump bump bump bump bump bump bump bump
     * bump
     */
    int bar();
